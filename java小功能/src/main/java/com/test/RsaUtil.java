...
public class RsaUtil {
    public static String yourPublicKey = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCm1YchJdHVy9iXsDfQfMEB2mdO" +
    ...
    public static String your_PRIVATE_KEY = "MIICdgIBADANBgkqhkiG9w0BAQEFAASCAmAwggJcAgEAAoGBAKbVhyEl0dXL2Jew" +
    ...
    public static void main(String[] args) throws Exception {
      ...
      /*  genKeyPair();
        ...
        //加密字符串
        String message = "1";
        String messageEn = encrypt(message, yourPublicKey);
        System.out.println(message + "\t加密后的字符串为:" + messageEn);
        //解密
        String messageDe = decrypt(messageEn, your_PRIVATE_KEY);
